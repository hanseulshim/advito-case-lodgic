...
const createRow = (id) => {
	return {
		...
		gcn: faker.random.number(1000),
		locator: `Locator - ${faker.random.number(1000)}`,
		agency_name: `Agency Name - ${faker.random.number(1000)}`,
		apollo_property_id: faker.random.number(1000),
		sabre_property_id: faker.random.number(1000),
		traveler: `Traveler - ${faker.random.number(1000)}`,
		agency_code: `Agency Code - ${faker.random.number(1000)}`,
		amadeus_property_id: faker.random.number(1000),
		booking_source: `Booking Source - ${faker.random.number(1000)}`,
		global_hotel_reason_code: faker.random.number(1000),
		local_hotel_reason_code: faker.random.number(1000),
		merchant_id: faker.random.number(1000),
		worldspan_property_id: faker.random.number(1000),
		...
		int_dom: faker.random.number(1000),
		internal_hotel_code: faker.random.number(1000),
		lanyon_id: faker.random.number(1000),
		original_document_number: faker.random.number(1000),
		refund_indicator: `Refund Indicator - ${faker.random.number(1000)}`,
		city_name: faker.address.city(),
		hrs_id: faker.random.number(1000),
		...
		confirmation_number: faker.random.number(1000),
		country_code: faker.address.country(),
		country_name: faker.address.countryCode(),
		hotel_chain_code: faker.random.number(1000),
		invoice_date: faker.date.recent(100),
		phone_number: faker.phone.phoneNumberFormat(),
		zip_or_postal_code: faker.address.zipCode(),
		...
		hotel_latitude: faker.address.latitude(),
		hotel_longitude: faker.address.longitude(),
		start_date: faker.date.recent(100),
		check_out_date: faker.date.recent(-100),
		major_city: faker.address.city(),
		number_of_nights: faker.random.number(1000),
		...
		business_unit_id: faker.random.number(1000),
		...
		rate_category: faker.random.number(1000),
		room_spend: faker.random.number(1000),
		total_amount: faker.random.number(1000),
		traveler_first_name: faker.name.firstName(),
		traveler_id: faker.random.number(1000),
		booking_date: faker.date.recent(100),
		f_b_spend: faker.random.number(1000),
		folio_number: faker.random.number(1000),
		highest_rate_available: faker.random.number(1000),
		hotel_confirmation_number: faker.random.number(1000),
		in_room_dining: faker.random.boolean(),
		lowest_rate_available: faker.random.number(1000),
		parking: faker.random.boolean(),
		service_fees: faker.random.boolean(),
		wifi: faker.random.boolean(),
		amadeus_id: faker.random.number(1000),
		conversion_rate: faker.finance.amount(1, 100, 2),
		entertainment: faker.random.boolean(),
		other_spend: faker.random.boolean(),
		source_currency_code: faker.finance.currencyCode(),
		total_hotel_spend: faker.random.number(1000),
		transaction_currency_code: faker.finance.currencyCode(),
		transportation: faker.random.boolean(),
		apollo_id: faker.random.number(1000),
		sabre_id: faker.random.number(1000),
		worldspan_id: faker.random.number(1000),
		...
		is_processed: true,
		is_matched: true,
		matched_hotel_property_id: faker.random.number(1000),
